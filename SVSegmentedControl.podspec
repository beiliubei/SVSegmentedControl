Pod::Spec.new do |s|
  s.name     = 'SVSegmentedControlFork'
  s.version  = '1.0'
  s.platform = :ios, '5.0'
  s.license  = 'MIT'
  s.summary  = 'A UISwitch-like segmented control for your iOS app.'
  s.homepage = 'https://github.com/beiliubei/SVSegmentedControl'
  s.author   = { 'Sam Vermette' => 'hello@samvermette.com' }
  s.source   = { :git => 'https://github.com/beiliubei/SVSegmentedControl.git', :tag => s.version.to_s }
